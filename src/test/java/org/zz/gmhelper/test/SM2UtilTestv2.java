...
public class SM2UtilTestv2 extends GMBaseTest {
    ...
    public void testEncryptAndDecrypt() {
        try {
            String[] keyPairHexString = SM2Util.generateKeyPairByHexString();
            String priKeyHex = keyPairHexString[0];
            String pubKeyHex = keyPairHexString[1];

            ECPrivateKeyParameters priKey = BCECUtil.createECPrivateKeyParameters(priKeyHex, SM2Util.DOMAIN_PARAMS);
            ECPublicKeyParameters pubKey = BCECUtil.createECPublicKeyParameters(pubKeyHex);
